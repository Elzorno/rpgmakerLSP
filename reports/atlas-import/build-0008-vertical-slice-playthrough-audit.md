...
| found | Critical Route | `ROUTE-003` | Map 1 event Tremor Trigger | Event id 6 at (8, 6) |
| found | Critical Route | `ROUTE-004` | Map 1 event TRN-HOM-005 North path to Skyreach | Event id 9 at (8, 0) |
| found | Critical Route | `ROUTE-005` | Map 4 event TRN-HOM-009 Enter Hidden Cave | Event id 3 at (8, 0) |
| found | Critical Route | `ROUTE-006` | Map 5 event Hidden Cave First Entry | Event id 1 at (8, 9) |
| found | Critical Route | `ROUTE-007` | Map 5 event TRN-HOM-011 Enter trials | Event id 3 at (8, 0) |
| found | Critical Route | `ROUTE-008` | Map 6 event Body Trial | Event id 1 at (4, 4) |
| found | Critical Route | `ROUTE-009` | Map 6 event Mind Trial | Event id 2 at (8, 4) |
| found | Critical Route | `ROUTE-010` | Map 6 event Heart Trial | Event id 3 at (12, 4) |
| found | Critical Route | `ROUTE-011` | Map 6 event TRN-HOM-013 Enter Sword Sanctum | Event id 6 at (8, 0) |
| found | Critical Route | `ROUTE-012` | Map 7 event Sword Pedestal | Event id 1 at (8, 5) |
| found | Critical Route | `ROUTE-013` | Map 8 event Glassfield Seal | Event id 1 at (8, 3) |
| found | Critical Route | `ROUTE-014` | Map 8 event TRN-HOM-017 Enter Sealed Node | Event id 4 at (8, 0) |
| found | Critical Route | `ROUTE-015` | Map 9 event Sealed Node First Entry | Event id 1 at (8, 9) |
| found | Critical Route | `ROUTE-016` | Map 10 event Core Path Door | Event id 1 at (8, 5) |
| found | Critical Route | `ROUTE-017` | Map 11 event Node Seven Guardian | Event id 1 at (8, 5) |
| found | Critical Route | `ROUTE-018` | Map 11 event TRN-HOM-023 Enter relay core | Event id 3 at (8, 0) |
...
| found | Critical Route | `RETURN-001` | Map 7 event TRN-HOM-014 Return from sanctum | Event id 2 at (8, 12) |
| found | Critical Route | `RETURN-002` | Map 6 event TRN-HOM-012 Return to entrance | Event id 5 at (8, 12) |
| found | Critical Route | `RETURN-003` | Map 5 event TRN-HOM-010 Exit cave | Event id 2 at (8, 12) |
| found | Critical Route | `RETURN-004` | Map 4 event TRN-HOM-006 Return from Skyreach route | Event id 2 at (8, 12) |
| found | Critical Route | `RETURN-005` | Map 9 event TRN-HOM-018 Exit Sealed Node | Event id 2 at (8, 12) |
| found | Critical Route | `RETURN-006` | Map 10 event TRN-HOM-020 Return to upper node | Event id 2 at (8, 12) |
| found | Critical Route | `RETURN-007` | Map 11 event TRN-HOM-022 Return to core path | Event id 2 at (8, 12) |
