...
| found | Atlas Event Commands | `EVT-HOM-001-EXEC` | EVT-HOM-001 has executable commands | codes=101x1, 122x2, 123x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-001-REQ` | EVT-HOM-001 includes required command family | codes=101x1, 122x2, 123x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-002` | EVT-HOM-002 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-002-EXEC` | EVT-HOM-002 has executable commands | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-002-REQ` | EVT-HOM-002 includes required command family | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-003` | EVT-HOM-003 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-003-EXEC` | EVT-HOM-003 has executable commands | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-003-REQ` | EVT-HOM-003 includes required command family | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-004` | EVT-HOM-004 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-004-EXEC` | EVT-HOM-004 has executable commands | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-004-REQ` | EVT-HOM-004 includes required command family | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-005` | EVT-HOM-005 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-005-EXEC` | EVT-HOM-005 has executable commands | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-005-REQ` | EVT-HOM-005 includes required command family | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-006` | EVT-HOM-006 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-006-EXEC` | EVT-HOM-006 has executable commands | codes=101x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-006-REQ` | EVT-HOM-006 includes required command family | codes=101x1, 401x1 |
...
| found | Atlas Event Commands | `EVT-HOM-008-EXEC` | EVT-HOM-008 has executable commands | codes=302x1 |
| found | Atlas Event Commands | `EVT-HOM-008-REQ` | EVT-HOM-008 includes required command family | codes=302x1 |
| found | Atlas Event Commands | `EVT-HOM-009` | EVT-HOM-009 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-009-EXEC` | EVT-HOM-009 has executable commands | codes=101x1, 121x2, 123x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-009-REQ` | EVT-HOM-009 includes required command family | codes=101x1, 121x2, 123x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-010` | EVT-HOM-010 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-010-EXEC` | EVT-HOM-010 has executable commands | codes=101x2, 111x1, 401x2, 411x1, 412x1 |
| found | Atlas Event Commands | `EVT-HOM-010-REQ` | EVT-HOM-010 includes required command family | codes=101x2, 111x1, 401x2, 411x1, 412x1 |
| found | Atlas Event Commands | `EVT-HOM-011` | EVT-HOM-011 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-011-EXEC` | EVT-HOM-011 has executable commands | codes=101x1, 121x1, 123x1, 212x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-011-REQ` | EVT-HOM-011 includes required command family | codes=101x1, 121x1, 123x1, 212x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-012` | EVT-HOM-012 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-012-EXEC` | EVT-HOM-012 has executable commands | codes=101x1, 117x1, 121x3, 122x1, 123x1, 212x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-012-REQ` | EVT-HOM-012 includes required command family | codes=101x1, 117x1, 121x3, 122x1, 123x1, 212x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-013` | EVT-HOM-013 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-013-EXEC` | EVT-HOM-013 has executable commands | codes=101x1, 117x1, 121x3, 122x1, 123x1, 212x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-013-REQ` | EVT-HOM-013 includes required command family | codes=101x1, 117x1, 121x3, 122x1, 123x1, 212x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-014` | EVT-HOM-014 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-014-EXEC` | EVT-HOM-014 has executable commands | codes=101x3, 102x1, 117x3, 121x6, 122x3, 123x2, 212x1, 250x1, 401x3, 402x3, 404x1 |
| found | Atlas Event Commands | `EVT-HOM-014-REQ` | EVT-HOM-014 includes required command family | codes=101x3, 102x1, 117x3, 121x6, 122x3, 123x2, 212x1, 250x1, 401x3, 402x3, 404x1 |
| found | Atlas Event Commands | `EVT-HOM-015` | EVT-HOM-015 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-015-EXEC` | EVT-HOM-015 has executable commands | codes=101x1, 212x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-015-REQ` | EVT-HOM-015 includes required command family | codes=101x1, 212x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-016` | EVT-HOM-016 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-016-EXEC` | EVT-HOM-016 has executable commands | codes=101x1, 121x1, 122x1, 123x1, 126x1, 127x1, 212x1, 250x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-016-REQ` | EVT-HOM-016 includes required command family | codes=101x1, 121x1, 122x1, 123x1, 126x1, 127x1, 212x1, 250x1, 401x1 |
...
| found | Atlas Event Commands | `EVT-HOM-025-EXEC` | EVT-HOM-025 has executable commands | codes=101x3, 102x1, 111x1, 121x1, 401x3, 402x2, 404x1, 411x1, 412x1 |
| found | Atlas Event Commands | `EVT-HOM-025-REQ` | EVT-HOM-025 includes required command family | codes=101x3, 102x1, 111x1, 121x1, 401x3, 402x2, 404x1, 411x1, 412x1 |
...
| found | Local Anchor Commands | `INT-ASH-WARM-STONE-VENT-EXEC` | INT-ASH-WARM-STONE-VENT has executable commands | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-WARM-STONE-VENT-REQ` | INT-ASH-WARM-STONE-VENT includes required command family | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-OLD-PANEL` | INT-ASH-OLD-PANEL event exists | event found |
| found | Local Anchor Commands | `INT-ASH-OLD-PANEL-EXEC` | INT-ASH-OLD-PANEL has executable commands | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-OLD-PANEL-REQ` | INT-ASH-OLD-PANEL includes required command family | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-ELARA-KEEPSAKE` | INT-ASH-ELARA-KEEPSAKE event exists | event found |
| found | Local Anchor Commands | `INT-ASH-ELARA-KEEPSAKE-EXEC` | INT-ASH-ELARA-KEEPSAKE has executable commands | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-ELARA-KEEPSAKE-REQ` | INT-ASH-ELARA-KEEPSAKE includes required command family | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-SHOP-CABINET` | INT-ASH-SHOP-CABINET event exists | event found |
| found | Local Anchor Commands | `INT-ASH-SHOP-CABINET-EXEC` | INT-ASH-SHOP-CABINET has executable commands | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-ASH-SHOP-CABINET-REQ` | INT-ASH-SHOP-CABINET includes required command family | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-SKY-GEOMETRIC-STONES` | INT-SKY-GEOMETRIC-STONES event exists | event found |
| found | Local Anchor Commands | `INT-SKY-GEOMETRIC-STONES-EXEC` | INT-SKY-GEOMETRIC-STONES has executable commands | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-SKY-GEOMETRIC-STONES-REQ` | INT-SKY-GEOMETRIC-STONES includes required command family | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-HCV-WALL-CARVING` | INT-HCV-WALL-CARVING event exists | event found |
| found | Local Anchor Commands | `INT-HCV-WALL-CARVING-EXEC` | INT-HCV-WALL-CARVING has executable commands | codes=101x1, 401x1 |
| found | Local Anchor Commands | `INT-HCV-WALL-CARVING-REQ` | INT-HCV-WALL-CARVING includes required command family | codes=101x1, 401x1 |
...
| found | Transfer Commands | `TRN-HOM-001-EXEC` | TRN-HOM-001 has executable commands | codes=201x1, 221x1, 222x1 |
| found | Transfer Commands | `TRN-HOM-001-REQ` | TRN-HOM-001 includes required command family | codes=201x1, 221x1, 222x1 |
...
| found | Transfer Commands | `TRN-HOM-005-EXEC` | TRN-HOM-005 has executable commands | codes=101x1, 201x1, 221x1, 222x1, 401x1 |
| found | Transfer Commands | `TRN-HOM-005-REQ` | TRN-HOM-005 includes required command family | codes=101x1, 201x1, 221x1, 222x1, 401x1 |
...
| found | Transfer Commands | `TRN-HOM-013-EXEC` | TRN-HOM-013 has executable commands | codes=101x3, 111x3, 201x1, 221x1, 222x1, 401x3, 411x3, 412x3 |
| found | Transfer Commands | `TRN-HOM-013-REQ` | TRN-HOM-013 includes required command family | codes=101x3, 111x3, 201x1, 221x1, 222x1, 401x3, 411x3, 412x3 |
...
| found | Transfer Commands | `TRN-HOM-025-EXEC` | TRN-HOM-025 has executable commands | codes=101x2, 102x1, 111x1, 121x1, 201x1, 221x1, 222x1, 401x2, 402x2, 404x1, 411x1, 412x1 |
| found | Transfer Commands | `TRN-HOM-025-REQ` | TRN-HOM-025 includes required command family | codes=101x2, 102x1, 111x1, 121x1, 201x1, 221x1, 222x1, 401x2, 402x2, 404x1, 411x1, 412x1 |
