...
|---|---:|---:|---:|---:|
| Critical Route | 30 | 1 | 0 | 0 |
| Critical Route Effects | 33 | 4 | 0 | 0 |
| Manual Runtime Scope | 0 | 0 | 0 | 1 |
| Return Transfers | 7 | 2 | 0 | 0 |
| Start State | 2 | 0 | 0 | 0 |
...
|---|---|---|---|---|
| missing | Critical Route | `ROUTE-001` | Map 2 event Player Start | Event not found |
...
| found | Critical Route | `ROUTE-019` | Map 12 event Relay Core | Event id 1 at (11, 8) |
| found | Critical Route | `ROUTE-020` | Map 13 event TRN-HOM-025 Begin departure | Event id 5 at (30, 14) |
| found | Critical Route | `ROUTE-021` | Map 14 event Departure Sequence | Event id 1 at (11, 10) |
| found | Critical Route | `ROUTE-022` | Map 14 event TRN-HOM-026 Destination TBD: Coalmouth or landing screen | Event id 2 at (11, 1) |
...
| found | Critical Route | `RETURN-008` | Map 12 event TRN-HOM-024 Return from relay core | Event id 2 at (11, 18) |
| found | Critical Route | `RETURN-009` | Map 13 event TRN-HOM-008 Return from Rustshore route | Event id 4 at (0, 18) |
...
| missing | Critical Route Effects | `ROUTE-004` | TRN-HOM-005 North path to Skyreach: Transfer to Skyreach | Missing: Transfer to Skyreach |
...
| missing | Critical Route Effects | `ROUTE-009` | Mind Trial: J1_Trial_Mind_Clear ON | Missing: J1_Trial_Mind_Clear ON |
...
| missing | Critical Route Effects | `ROUTE-019` | Relay Core: J1_Node07_RelayRestored ON | Missing: J1_Node07_RelayRestored ON |
| missing | Critical Route Effects | `ROUTE-019` | Relay Core: J1_Mainland_TravelUnlocked ON | Missing: J1_Mainland_TravelUnlocked ON |
...
| missing | Return Transfers | `RETURN-004` | TRN-HOM-006 Return from Skyreach route: transfer to map 1 | Missing: Transfer to map 1 |
...
| missing | Return Transfers | `RETURN-009` | TRN-HOM-008 Return from Rustshore route: transfer to map 1 | Missing: Transfer to map 1 |
