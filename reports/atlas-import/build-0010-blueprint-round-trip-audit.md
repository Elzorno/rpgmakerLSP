...
| found | Map Shape | `MAP-007` | BUILD-0009 blueprint marker | note contains BP-SCR-HOM-ASH-001-001 |
...
| found | Encounter Policy | `ENC-001` | Blueprint declares safe village region | safe regions=1 |
| found | Encounter Policy | `ENC-002` | RPG Maker encounter list is empty | encounterList=[] |
| found | Encounter Policy | `ENC-003` | No encounter regions painted in Ashford | nonzero region IDs=[] |
