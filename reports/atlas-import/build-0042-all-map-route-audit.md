...
|---|---:|---:|---:|
| Reachability | 17 | 0 | 0 |
| Transfer Command | 60 | 0 | 0 |
| Transfer Event | 90 | 0 | 0 |
| Transfer Hygiene | 1 | 0 | 0 |
...
| found | Reachability | `REACH-SCR-HOM-ASH-001` | SCR-HOM-ASH-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-ASH-002` | SCR-HOM-ASH-002 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-ASH-003` | SCR-HOM-ASH-003 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-FOG-001` | SCR-HOM-FOG-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-FOG-002` | SCR-HOM-FOG-002 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-GLS-001` | SCR-HOM-GLS-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-HCV-001` | SCR-HOM-HCV-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-HCV-002` | SCR-HOM-HCV-002 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-HCV-003` | SCR-HOM-HCV-003 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-RST-001` | SCR-HOM-RST-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-RST-002` | SCR-HOM-RST-002 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-SKY-001` | SCR-HOM-SKY-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-SND-001` | SCR-HOM-SND-001 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-SND-002` | SCR-HOM-SND-002 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-SND-003` | SCR-HOM-SND-003 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
| found | Reachability | `REACH-SCR-HOM-SND-004` | SCR-HOM-SND-004 reachable from SCR-HOM-ASH-002 | reachable screens=16 |
...
| found | Transfer Command | `TRN-HOM-001-DEST` | TRN-HOM-001 destination coordinate is in bounds | (8, 6) in 40x32=True |
| found | Transfer Command | `TRN-HOM-002-CMD` | TRN-HOM-002 transfers to map 2 | transfer command to map 2 |
| found | Transfer Command | `TRN-HOM-002-DEST` | TRN-HOM-002 destination coordinate is in bounds | (8, 6) in 17x13=True |
...
| found | Transfer Command | `TRN-HOM-004-DEST` | TRN-HOM-004 destination coordinate is in bounds | (8, 6) in 40x32=True |
| found | Transfer Command | `TRN-HOM-005-CMD` | TRN-HOM-005 transfers to map 4 | transfer command to map 4 |
| found | Transfer Command | `TRN-HOM-005-DEST` | TRN-HOM-005 destination coordinate is in bounds | (8, 6) in 30x40=True |
| found | Transfer Command | `TRN-HOM-006-CMD` | TRN-HOM-006 transfers to map 1 | transfer command to map 1 |
| found | Transfer Command | `TRN-HOM-006-DEST` | TRN-HOM-006 destination coordinate is in bounds | (8, 6) in 40x32=True |
| found | Transfer Command | `TRN-HOM-007-CMD` | TRN-HOM-007 transfers to map 13 | transfer command to map 13 |
| found | Transfer Command | `TRN-HOM-007-DEST` | TRN-HOM-007 destination coordinate is in bounds | (8, 6) in 34x26=True |
| found | Transfer Command | `TRN-HOM-008-CMD` | TRN-HOM-008 transfers to map 1 | transfer command to map 1 |
| found | Transfer Command | `TRN-HOM-008-DEST` | TRN-HOM-008 destination coordinate is in bounds | (8, 6) in 40x32=True |
...
| found | Transfer Command | `TRN-HOM-015-CMD` | TRN-HOM-015 transfers to map 8 | transfer command to map 8 |
| found | Transfer Command | `TRN-HOM-015-DEST` | TRN-HOM-015 destination coordinate is in bounds | (8, 6) in 42x34=True |
| found | Transfer Command | `TRN-HOM-016-CMD` | TRN-HOM-016 transfers to map 1 | transfer command to map 1 |
| found | Transfer Command | `TRN-HOM-016-DEST` | TRN-HOM-016 destination coordinate is in bounds | (8, 6) in 40x32=True |
...
| found | Transfer Command | `TRN-HOM-027-CMD` | TRN-HOM-027 transfers to map 15 | transfer command to map 15 |
| found | Transfer Command | `TRN-HOM-027-DEST` | TRN-HOM-027 destination coordinate is in bounds | (8, 6) in 40x32=True |
| found | Transfer Command | `TRN-HOM-028-CMD` | TRN-HOM-028 transfers to map 1 | transfer command to map 1 |
| found | Transfer Command | `TRN-HOM-028-DEST` | TRN-HOM-028 destination coordinate is in bounds | (8, 6) in 40x32=True |
...
| found | Transfer Event | `TRN-HOM-001-TILE` | TRN-HOM-001 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-002-TILE` | TRN-HOM-002 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-003-TILE` | TRN-HOM-003 event sits on concrete tile | layer0 tile=2836 |
| found | Transfer Event | `TRN-HOM-004` | TRN-HOM-004 event exists on SCR-HOM-ASH-003 | event containing transfer ID |
| found | Transfer Event | `TRN-HOM-004-POS` | TRN-HOM-004 event is in source map bounds | event position=(8, 12) source size=17x13 |
| found | Transfer Event | `TRN-HOM-004-TILE` | TRN-HOM-004 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-005-TILE` | TRN-HOM-005 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-006-TILE` | TRN-HOM-006 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-007-TILE` | TRN-HOM-007 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-009-TILE` | TRN-HOM-009 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-015-TILE` | TRN-HOM-015 event sits on concrete tile | layer0 tile=2836 |
...
| found | Transfer Event | `TRN-HOM-027-TILE` | TRN-HOM-027 event sits on concrete tile | layer0 tile=2836 |
...
| Status | Category | Check ID | Expected | Detail |
|---|---|---|---|---|
| found | Transfer Hygiene | `ORPHAN-000` | No orphan transfer events | All TRN-HOM events found in maps are present in Atlas export |
