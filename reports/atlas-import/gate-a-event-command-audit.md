...
| found | Atlas Event Commands | `EVT-HOM-013-EXEC` | EVT-HOM-013 has executable commands | codes=101x2, 122x1, 401x2 |
| found | Atlas Event Commands | `EVT-HOM-013-REQ` | EVT-HOM-013 includes required command family | codes=101x2, 122x1, 401x2 |
...
| found | Atlas Event Commands | `EVT-HOM-017-EXEC` | EVT-HOM-017 has executable commands | codes=101x2, 121x1, 123x1, 212x1, 250x1, 401x4 |
| found | Atlas Event Commands | `EVT-HOM-017-REQ` | EVT-HOM-017 includes required command family | codes=101x2, 121x1, 123x1, 212x1, 250x1, 401x4 |
| found | Atlas Event Commands | `EVT-HOM-018` | EVT-HOM-018 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-018-EXEC` | EVT-HOM-018 has executable commands | codes=101x2, 123x1, 212x1, 250x1, 401x4 |
| found | Atlas Event Commands | `EVT-HOM-018-REQ` | EVT-HOM-018 includes required command family | codes=101x2, 123x1, 212x1, 250x1, 401x4 |
...
| found | Atlas Event Commands | `EVT-HOM-021-EXEC` | EVT-HOM-021 has executable commands | codes=101x1, 121x1, 123x1, 301x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-021-REQ` | EVT-HOM-021 includes required command family | codes=101x1, 121x1, 123x1, 301x1, 401x1 |
| found | Atlas Event Commands | `EVT-HOM-022` | EVT-HOM-022 event exists | event found |
| found | Atlas Event Commands | `EVT-HOM-022-EXEC` | EVT-HOM-022 has executable commands | codes=101x3, 121x3, 122x2, 250x1, 401x4 |
| found | Atlas Event Commands | `EVT-HOM-022-REQ` | EVT-HOM-022 includes required command family | codes=101x3, 121x3, 122x2, 250x1, 401x4 |
...
| found | Atlas Event Commands | `EVT-HOM-024-EXEC` | EVT-HOM-024 has executable commands | codes=101x2, 123x1, 212x1, 250x1, 401x2 |
| found | Atlas Event Commands | `EVT-HOM-024-REQ` | EVT-HOM-024 includes required command family | codes=101x2, 123x1, 212x1, 250x1, 401x2 |
...
| found | Transfer Commands | `TRN-HOM-017-EXEC` | TRN-HOM-017 has executable commands | codes=101x1, 201x1, 221x1, 222x1, 401x2 |
| found | Transfer Commands | `TRN-HOM-017-REQ` | TRN-HOM-017 includes required command family | codes=101x1, 201x1, 221x1, 222x1, 401x2 |
