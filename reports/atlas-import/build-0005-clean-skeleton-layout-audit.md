...
| found | Executable Event Logic | `EVT-HOM-007` | SCR-HOM-ASH-001 - Hidden Item | Executable command codes: 0, 101, 108, 123, 126, 401 |
| found | Executable Event Logic | `EVT-HOM-008` | SCR-HOM-ASH-003 - Shopkeeper | Executable command codes: 0, 108, 302 |
| found | Executable Event Logic | `EVT-HOM-009` | SCR-HOM-ASH-001 - Tremor Trigger | Executable command codes: 0, 101, 108, 121, 123, 401 |
...
| found | Executable Event Logic | `EVT-HOM-011` | SCR-HOM-HCV-001 - Hidden Cave First Entry | Executable command codes: 0, 101, 108, 121, 123, 401 |
| found | Executable Event Logic | `EVT-HOM-012` | SCR-HOM-HCV-002 - Body Trial | Executable command codes: 0, 101, 108, 117, 121, 122, 123, 401 |
| found | Executable Event Logic | `EVT-HOM-013` | SCR-HOM-HCV-002 - Mind Trial | Executable command codes: 0, 101, 108, 117, 121, 122, 123, 401 |
| found | Executable Event Logic | `EVT-HOM-014` | SCR-HOM-HCV-002 - Heart Trial | Executable command codes: 0, 101, 102, 108, 117, 121, 122, 123, 401, 402, 404 |
| found | Executable Event Logic | `EVT-HOM-015` | SCR-HOM-HCV-002 - Sanctum Gate | Executable command codes: 0, 101, 108, 401 |
| found | Executable Event Logic | `EVT-HOM-016` | SCR-HOM-HCV-003 - Sword Pedestal | Executable command codes: 0, 101, 108, 121, 122, 123, 126, 127, 401 |
| found | Executable Event Logic | `EVT-HOM-017` | SCR-HOM-GLS-001 - Glassfield Seal | Executable command codes: 0, 101, 108, 121, 123, 401 |
| found | Executable Event Logic | `EVT-HOM-018` | SCR-HOM-GLS-001 - Surface Fragment | Executable command codes: 0, 101, 108, 123, 401 |
...
| found | Executable Event Logic | `EVT-HOM-020` | SCR-HOM-SND-002 - Core Path Door | Executable command codes: 0, 101, 108, 121, 123, 401 |
| found | Executable Event Logic | `EVT-HOM-021` | SCR-HOM-SND-003 - Node Seven Guardian | Executable command codes: 0, 101, 108, 121, 123, 301, 401 |
| found | Executable Event Logic | `EVT-HOM-022` | SCR-HOM-SND-004 - Relay Core | Executable command codes: 0, 101, 108, 121, 122, 123, 401 |
| found | Executable Event Logic | `EVT-HOM-023` | SCR-HOM-RST-001 - Dockmaster | Executable command codes: 0, 101, 108, 111, 401, 411, 412 |
| found | Executable Event Logic | `EVT-HOM-024` | SCR-HOM-RST-001 - Lighthouse Examine | Executable command codes: 0, 101, 108, 123, 401 |
...
| found | Executable Event Logic | `EVT-HOM-026` | SCR-HOM-RST-002 - Departure Sequence | Executable command codes: 0, 101, 108, 122, 123, 401 |
...
| found | Executable Event Logic | `EVT-HOM-028` | SCR-HOM-FOG-001 - Hidden Item Landmark | Executable command codes: 0, 101, 108, 123, 126, 401 |
| found | Executable Event Logic | `EVT-HOM-029` | SCR-HOM-FOG-001 - Signal-Tick Reed Pool | Executable command codes: 0, 101, 108, 123, 401 |
...
| found | Executable Event Logic | `EVT-HOM-031` | SCR-HOM-FOG-002 - Signal Pool / Cable Cluster Examine | Executable command codes: 0, 101, 108, 123, 401 |
...
| Status | Category | Atlas / Expected ID | Expected | Detail |
|---|---|---|---|---|
| found | Map Layout Readiness | `SCR-HOM-ASH-001` | Map 1 - TWN_Ashford_Exterior | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-SKY-001` | Map 4 - DGN_SkyreachHill_Path | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-HCV-001` | Map 5 - DGN_HiddenCave_Entrance | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-HCV-002` | Map 6 - DGN_HiddenCave_Trials | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-HCV-003` | Map 7 - DGN_HiddenCave_Sanctum | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-GLS-001` | Map 8 - DGN_Glassfield_Ruins_Exterior | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-SND-001` | Map 9 - DGN_SealedNode_Upper | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-SND-002` | Map 10 - DGN_SealedNode_CorePath | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-SND-003` | Map 11 - DGN_SealedNode_Guardian | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-SND-004` | Map 12 - DGN_SealedNode_RelayCore | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-RST-001` | Map 13 - TWN_Rustshore_Docks | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-RST-002` | Map 14 - CUT_Mainland_Departure | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-FOG-001` | Map 15 - FLD_Fogfen_Marsh_Field | Base terrain tiles painted: 221 |
...
| found | Map Layout Readiness | `SCR-HOM-FOG-002` | Map 16 - FLD_Fogfen_Deeper_Marsh_Pocket | Base terrain tiles painted: 221 |
