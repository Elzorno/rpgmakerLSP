...
| found | Atlas Event Commands | `EVT-HOM-005-EXEC` | EVT-HOM-005 has executable commands | codes=101x2, 401x5 |
| found | Atlas Event Commands | `EVT-HOM-005-REQ` | EVT-HOM-005 includes required command family | codes=101x2, 401x5 |
