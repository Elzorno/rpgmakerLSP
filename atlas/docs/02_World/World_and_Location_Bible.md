...
This document defines the world structure, required locations, overworld placement logic, and region-by-region purpose for _The Last Sword Protocol_.

It is the bridge between story and maps.
...
Each major region teaches one question.

| Progression | Region | Story Question | Gameplay Role |
|---|---|---|---|
| Journey I | Kai's Home Island | Who am I? | Tutorial, Sword awakening, first relay |
| Journey II-A | Coalmouth Region | What happened underground? | First mainland town, Vera joins, automation theme |
...
- Gameplay purpose: first relay shutdown, first boss, Journey I climax.
...
- Gameplay purpose: first mainland automation dungeon.
...
Exact numbering can be revised later, but the island should remain Node 7 to preserve the story beat: `NODE SEVEN OFFLINE`.

---

## Overworld Map Placement Guidance
...
This page should later split into region packets:

- Home Island Design Packet
- Ashford Design Packet
- Coalmouth Region Packet
- Athenaeum Region Packet
- Irongate Region Packet
- Driftlands Packet
- New Meridian Packet
- Dead Circuit Packet
- Vault Packet
- Optional Locations Packet

---

## Canonical Summary

The world of _The Last Sword Protocol_ should feel like a Dragon Quest fantasy world built over the bones of a forgotten technological civilization.
...
| Version | Change |
|---|---|
| 0.5 | Migrated and refactored into Atlas World section |
