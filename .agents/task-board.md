...
Use this table to claim work before editing project files.

| ID | Owner | Status | Files | Summary | Updated |
| --- | --- | --- | --- | --- | --- |
| T001 | Codex | Done | AGENTS.md, .agents/ | Set up shared Codex-Claude coordination system | 2026-06-27 21:30 ET |
| T002 | Codex | Done | data/Enemies.json, data/Troops.json, .agents/ | Create 6 entry-level and 6 mid-level story-bible enemies plus troops | 2026-06-28 11:06 ET |
| T003 | Codex | Done | img/enemies/LSP_VirusWarpedSurveyor.png, .agents/ | Fix oversized Virus-Warped Surveyor battler rendering | 2026-06-28 11:10 ET |
| T004 | Codex | Done | data/Map018.json, .agents/ | Complete Chamber 2 Mental Trial tile layout from events | 2026-06-28 11:15 ET |
| T005 | Codex | Done | img/tilesets/LSP_Chamber2_Terminals.png, data/Tilesets.json, data/Map018.json, .agents/ | Create dedicated Chamber 2 steampunk terminal/server tileset | 2026-06-28 11:29 ET |

## Notes

- Create new task IDs sequentially: `T002`, `T003`, and so on.
...
| T034 | Codex | Done | TheLastSwordProtocol-Atlas/, tools/atlas-import/, .agents/ | WO-0018 Atlas export / game import contract | 2026-07-04 10:21 ET |
...
| T051 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/, ../TheLastSwordProtocol-Atlas/atlas/orchestrator/, .agents/ | WO-0026 read-only work-order audit | 2026-07-04 17:02 ET |
...
| T062 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0014 generate Sword Sanctum blueprint and map | 2026-07-04 22:15 ET |
| T063 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0015 generate Glassfield Ruins Exterior blueprint and map | 2026-07-04 22:19 ET |
| T064 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0016 generate Sealed Node Upper blueprint and map | 2026-07-04 22:23 ET |
| T065 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0017 generate Sealed Node Core Path blueprint and map | 2026-07-04 22:26 ET |
| T066 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0018 generate Sealed Node Guardian Chamber blueprint and map | 2026-07-04 22:30 ET |
| T067 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0019 generate Relay Node Seven Core blueprint and map | 2026-07-04 22:32 ET |
| T068 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0020 generate Rustshore Docks blueprint and map | 2026-07-04 22:36 ET |
| T069 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0021 generate Mainland Departure blueprint and map | 2026-07-04 22:39 ET |
| T070 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0022 generate Fogfen Marsh Field blueprint and map | 2026-07-04 22:48 ET |
| T071 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas-tools/mapgen/prototype/, tools/atlas-import/, ../TheLastSwordProtocol-Game/data/, reports/atlas-import/, .agents/ | BUILD-0023 generate Deeper Marsh Pocket blueprint and map | 2026-07-04 22:55 ET |
...
| T089 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/workorders/, tools/atlas-import/, reports/atlas-import/, .agents/ | BUILD-0041/0042 map guide order creation and BUILD-0041 guide images | 2026-07-05 09:28 ET |
...
| T094 | Claude | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, ../TheLastSwordProtocol-Atlas/atlas/docs/09_Technical/Implementation_Packets/Home_Island/, .agents/ | WO-0025 Ashford Exterior manual map-building packet (per Codex's BUILD-0043 recommendation) | 2026-07-05 11:10 ET |
| T095 | Claude | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, ../TheLastSwordProtocol-Atlas/atlas/docs/09_Technical/Implementation_Packets/Home_Island/, .agents/ | Fixed stale-candidate duplicate (WO-0026 regenerated WO-0025); executed corrected WO-0026 Elara House manual map-building packet (IMP-HOM-018) | 2026-07-05 11:35 ET |
| T096 | Claude | Done | ../TheLastSwordProtocol-Atlas/atlas/docs/03_Story/, ../TheLastSwordProtocol-Atlas/atlas/docs/99_Reference/Decision_Records/, ../TheLastSwordProtocol-Atlas/atlas/planning/, LastSwordProtocol_StoryBible*.md, .agents/ | WO-0027 / plan item A1: Story Bible v1.1 migrated to Atlas (ATLAS-STY-002), relay numbering locked (DDR-0003), legacy bibles superseded; reviewed and approved by Production Director, committed as Atlas 026ab98 | 2026-07-05 15:09 ET |
| T097 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/workorders/, .agents/ | Run Atlas planner next work order; created WO-0028 | 2026-07-05 15:12 ET |
| T098 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, .agents/ | Run Atlas planner next work order; created WO-0029 after duplicate cleanup | 2026-07-05 15:16 ET |
| T099 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, .agents/ | Run Atlas planner next work order; created WO-0030 after retiring duplicate WO-0029 candidate | 2026-07-05 15:17 ET |
| T100 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, .agents/ | Run Atlas planner next work order; created WO-0031 after duplicate cleanup | 2026-07-05 15:26 ET |
...
| T106 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, .agents/ | Ran Atlas planner next work order; blocked by empty active queue | 2026-07-05 20:34 ET |
| T107 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, .agents/ | Refilled Atlas queue with player-visible Journey I production work and created WO-0035 | 2026-07-05 20:42 ET |
| T108 | Claude | Done | ../TheLastSwordProtocol-Game/data/Map002.json, ../TheLastSwordProtocol-Game/data/System.json, ../TheLastSwordProtocol-Game/map_ownership.json, reports/atlas-import/, .agents/ | Executed WO-0035: hand-authored Gate A Elara House production map (Map002), five-state Elara dialogue from ATLAS-STY-010, exit lands beside Map001 door; ledger flipped to hand_authored; validate + ownership + route audits green (board claim recorded post-hoc; work done 2026-07-05 before board update) | 2026-07-06 15:09 ET |
| T109 | Claude | Done | ../TheLastSwordProtocol-Atlas/atlas/planning/, ../TheLastSwordProtocol-Atlas/atlas/workorders/, ../TheLastSwordProtocol-Game/data/Map001.json, ../TheLastSwordProtocol-Game/map_ownership.json, reports/atlas-import/, .agents/ | Ran Atlas planner (created WO-0036), retired its queue candidate, and executed WO-0036: hand-authored Gate A Ashford Exterior production map (Map001); validate + ownership + route audits green | 2026-07-06 15:32 ET |
| T110 | Codex | Done | tools/atlas-import/tile-palettes/, tools/atlas-import/validate_tile_palette.py, .agents/, ../TheLastSwordProtocol-Atlas/atlas/workorders/WO-0060-temperate-and-coastal-style-packs.md | Completed WO-0060 palette tooling and negative fixtures; live visual gate remains with Chris | 2026-07-13 00:00 ET |
| T111 | Codex | Done | tools/atlas-import/mapplan_candidate_compiler.py, tools/atlas-import/tests/, reports/atlas-import/wo0061/, .agents/, ../TheLastSwordProtocol-Atlas/atlas/workorders/WO-0061-mapplan-to-rpg-maker-candidate-compiler.md | Compiled identical MapPlan into guarded temperate/coastal disposable RPG Maker candidates | 2026-07-13 00:00 ET |
| T112 | Codex | Done | ../AtlasStudio/atlas-tools/mapgen/compiler/quality_auditor.py, tools/atlas-import/generate_wo0062_gallery.py, tools/atlas-import/tests/, reports/atlas-import/wo0062/, .agents/, ../TheLastSwordProtocol-Atlas/atlas/workorders/WO-0062-generation-validation-and-seed-gallery.md | Extended quality gates and produced ten-candidate deterministic seed gallery with negative controls | 2026-07-13 00:00 ET |
| T113 | Codex | Done | tools/atlas-import/generate_wo0063_*, tools/atlas-import/tests/, reports/atlas-import/wo0063/, .agents/, ../TheLastSwordProtocol-Atlas/atlas/workorders/WO-0063-first-generated-settlement-vertical-slice.md | Built six disposable non-canon settlement candidates; live RPG Maker review remains before GO | 2026-07-13 00:00 ET |
| T114 | Codex | Done | ../TheLastSwordProtocol-Atlas/atlas/docs/02_World/Screens/Home_Island/SCR_HOM_ASH_001_Ashford_Exterior.md, ../TheLastSwordProtocol-Atlas/atlas/docs/09_Technical/Implementation_Packets/Home_Island/IMP_HOM_017_Manual_Map_Build_Ashford_Exterior.md, reports/atlas-import/ashford-exterior-rebuild-reconciliation.md, .agents/ | Reconciled supplied Ashford design guide with canon before any Map001 rebuild | 2026-07-14 00:00 ET |
| T115 | Codex | Review | tools/atlas-import/build_ashford_exterior_candidate.py, reports/atlas-import/ashford-exterior-rebuild-v2/, .agents/ | Built reconciled Ashford exterior candidate; awaiting visual approval before protected Map001 installation | 2026-07-14 00:00 ET |
